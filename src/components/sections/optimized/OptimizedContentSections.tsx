...
const services = [
  ["laser_epilation", "Lazer Epilasyon", "Kıl kökü ve cilt analizine göre kişiye özel seans planı.", "/images/service-images/laser-hair-removal.webp"],
  ["male_laser_epilation", "Erkek Lazer Epilasyon", "Sırt, göğüs, ense ve yüz bölgesine uygun protokoller.", "/images/service-images/laser-hair-removal.webp"],
  ["needle_epilation", "İğneli Epilasyon", "Uygunluk değerlendirmesi sonrasında noktasal uygulama.", "/images/service-images/laser-hair-removal.webp"],
  ["skin_care", "Cilt Bakımı", "Cilt ihtiyacına göre analiz ve bakım adımları.", "/images/service-images/facial.webp"],
  ["regional_slimming", "Bölgesel İncelme", "Kişisel hedeflere göre planlanan destek uygulamaları.", "/images/hero.webp"],
  ["ems", "EMS", "Kas aktivasyonunu destekleyen bölgesel uygulama.", "/images/isparta-beauty-studio-hero.png"],
  ["permanent_makeup", "Kalıcı Makyaj", "Yüz oranı ve cilt tonuna uygun doğal tasarım.", "/images/service-images/makeup.webp"],
  ["microblading", "Microblading", "Kaş formuna göre kişiselleştirilen kıl tekniği.", "/images/service-images/brow-shaping.webp"],
  ["prosthetic_nails", "Protez Tırnak", "El ve tırnak yapısına göre şekillendirilen uygulama.", "/images/service-images/manicure.webp"],
  ["dermapen", "Dermapen", "Cilt değerlendirmesinden sonra planlanan bakım.", "/images/service-images/facial.webp"],
  ["free_skin_analysis", "Ücretsiz Cilt Analizi", "Cilt ihtiyaçlarını ve uygun bakım planını belirleme.", "/images/service-images/facial.webp"],
  ["golden_ratio_brow", "Altın Oran Kaş Alımı", "Yüz oranlarına göre kişisel kaş tasarımı.", "/images/service-images/brow-shaping.webp"],
] as const;
    ...
    <section className="mx-auto w-full max-w-[1448px] px-5 py-16 sm:px-10 sm:py-20 lg:px-12">
      ...
      <div className="grid gap-px overflow-hidden border border-white/10 bg-white/[0.06] shadow-[0_30px_70px_rgba(0,0,0,0.18)] sm:grid-cols-2 lg:grid-cols-3">
        {services.map(([id, title, text, image]) => (
          <button key={id} type="button" onClick={() => onServiceClick(id)} className="group bg-[rgba(11,17,15,0.98)] text-left transition-colors hover:bg-[rgba(16,24,20,0.98)]">
...
export function OptimizedFooter() {
  const links = [["Ana Sayfa", "#hero"], ["Hizmetler", "#services"], ["Kıl Kökü Analizi", "#analysis"], ["Uzmanlık Alanları", "#masters"], ["Google Yorumları", "#testimonials"], ["Hakkımızda", "#about"], ["Blog", "/blog"], ["Sık Sorulan Sorular", "#faq"]];
  return (
